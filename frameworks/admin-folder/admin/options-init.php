<?php
    ...
    $args = array(
        'opt_name' => $opt_name,
        'use_cdn' => TRUE,
        'display_name' => 'Track WP Mails Settings',
        'display_version' => FALSE,
        'page_slug' => 'pt_track_wp_mails-settings',   // @todo: Also update the page slug.
        'page_title' => 'Settings',
        'update_notice' => FALSE,
        'admin_bar' => FALSE,
        'menu_type' => 'submenu',
        'menu_title' => 'Settings',
        'allow_sub_menu' => TRUE,
        'page_parent' => 'pt_track_wp_mails', // @todo: add post_type OR page Slug accordingly
        'page_parent_post_type' => 'pt_track_wp_mails', // // @todo: Page Parent -- add post_type OR page Slug accordingly
        'customizer' => TRUE,
        'default_mark' => '*',
        'hints' => array(
    ...
    Redux::setSection( $opt_name, array(
		...
		'fields' => array(
			...
			array(
				...
				'description'	=> '<a target="_blank" href="'.wp_slash(plugin_dir_url(dirname(dirname(__DIR__)))).'debugging/read-log.php?sc=iedXER95JcONlLda">Click here to read file</a>',
